...
describe("FHERC20", function () {
  ...
  describe("mint", function () {
    it("should mint", async function () {
      ...
      await hre.fhe.mocks.expectPlaintext(await XFHE.encTotalSupply(), value);
  ...
  describe("burn", function () {
    it("should burn", async function () {
      ...
      await hre.fhe.mocks.expectPlaintext(await XFHE.encTotalSupply(), mintValue);
      ...
      await hre.fhe.mocks.expectPlaintext(await XFHE.encTotalSupply(), mintValue - burnValue);
  ...
  describe("encTransfer", function () {
    it("Should transfer from bob to alice", async function () {
      ...
      const encTransferResult = await fhe.encrypt([Encryptable.uint128(transferValueRaw)] as const);
  ...
  describe("encTransferFrom", function () {
    const setupEncTransferFromFixture = async () => {
      ...
      // Encrypt transfer value
      const transferValue = ethers.parseEther("1");
      const encTransferResult = await fhe.encrypt([Encryptable.uint128(transferValue)] as const);
      const [encTransferInput] = await hre.fhe.expectResultSuccess(encTransferResult);
